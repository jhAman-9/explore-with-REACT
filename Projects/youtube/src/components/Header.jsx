  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black">
      ...
      <div className="group flex items-center">
        <div className="felx h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
        ...
        <button
          className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border border-1-0 border-[#303030] rounded-r-3xl bg-white/[0.1] "
      ...
      <div className="flex items-center">
        <div className="hidden md:flex">
          ...
          <div className="flex items-center justify-center ml-2 h-10 w-10 rounded-l-full hover:bg-[#303030]/[0.6]">
